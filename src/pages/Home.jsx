                ...
                <Box display="flex" flexDirection="column" m={0} p={0}>
                    ...
                    <div style={{position:"relative", textAlign:"left"}}>
                        ...
                        <Link to="/products" style={{ color: 'inherit', textDecoration: 'none' }}>
                            <Button variant="primary" style={{position:"absolute", bottom:"26%", left:"6.7%", maxWidth:"45vw"}}>
                                <Typography>Go to products page</Typography>
                            </Button>
                        </Link>
                    </div >
                    <div style={{position:"relative", textAlign:"left"}}>
                        ...
                        <Link to="/contact" style={{ color: 'inherit', textDecoration: 'none' }}>
                            <Button variant="primary" style={{position:"absolute", bottom:"30%", left:"6.7%", maxWidth:"45vw"}}>
